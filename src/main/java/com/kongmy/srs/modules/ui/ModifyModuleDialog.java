 ...
 * @author Kong My
 */
public class ModifyModuleDialog extends javax.swing.JDialog {

    /**
     * Creates new form OntologyAttributesDialog
     */
    public ModifyModuleDialog(java.awt.Frame parent, boolean modal, OntologyModule module) {
        super(parent, modal);
        this.module = module;
        this.listModel = new DefaultListModel<>();
        module.getAllModules().forEach((val) -> listModel.addElement(val));
        initComponents();
    }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        list.getSelectedValuesList()
                .forEach((val) -> {
                    module.RemoveModule(val.toString());
