 ...
 * @author Kong My
 */
public class ModifyActorDialog extends javax.swing.JDialog {

    /**
     * Creates new form OntologyAttributesDialog
     */
    public ModifyActorDialog(java.awt.Frame parent, boolean modal, OntologyModule module) {
        super(parent, modal);
        this.module = module;
        this.listModel = new DefaultListModel<>();
        module.getAllActors().forEach((val) -> listModel.addElement(val));
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder("Actors"));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        list.getSelectedValuesList()
                .forEach((val) -> {
                    module.RemoveActor(val.toString());
